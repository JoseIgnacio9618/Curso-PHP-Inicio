...
<body>
	<form action="formularioRadioButtons.php" method="POST">
	...
	<?php
		...
		<p>
            <!-- Esta validación sirve para seleccionar el elemento previamente seleccionado al recargar 
        sirve para selecciones donde solo se puede rellenar 1 opcion de varias-->
		...
		<p>
            ...
            <!-- Esta validacion convierte el nombre de los checkbox en un array y luego al refrescar marca los 
        que ya estaban seleccionados vale para selecciones donde se puede rellenar mas de un checkbox-->
