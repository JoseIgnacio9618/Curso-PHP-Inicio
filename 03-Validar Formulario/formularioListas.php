...
<body>
	<form action="formularioListas.php" method="POST">
		<?php
			$nombre = "";
			$password = "";
			$email = "";
            ...
            //isset sirve para comprovar si una variable esta definida y no vacia
		...
		<p>
		Nombre:<br/>
        <!-- De esta forma al recargar vuelve a cargar la pagina con el valor seleccionado-->
